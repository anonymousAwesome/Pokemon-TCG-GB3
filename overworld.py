...
current_map=mapinfo.tcg_island
...
player=character.Player(current_map["player_starting_location"][0],current_map["player_starting_location"][1],character.sprites,scaled_bg_image)
...
def render():
    ...
    player.update(keys,current_map["obstacles"])
