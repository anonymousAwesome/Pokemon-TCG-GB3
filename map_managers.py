...
def check_all_interactions(map_holder,player_character,event_list,screen,map_input_lock,current_dialogue,temp_exit_list,overworld_event_manager,collision_manager):
    ...
    check_interact_with_self(map_holder,player_character,event_list,screen,map_input_lock,overworld_event_manager,current_dialogue,collision_manager,temp_exit_list)
...
def check_interact_with_self(map_holder,player_character,event_list,screen,map_input_lock,overworld_event_manager,current_dialogue,collision_manager,temp_exit_list):
                    ...
                    if event.key==key_mappings.affirm_key:
                        for map_object in interact_object:
                            ...
                            if temp_map_object.rect.contains(player_character.rect):
                                temp_map_object.interact_self(map_holder, screen,overworld_event_manager,collision_manager,player_character,temp_exit_list)